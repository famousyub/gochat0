...
var validInputs = []string{
	...
	`{
		...
		"fmt":[{"len":22}],
		"txt":"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4"
	}`,
	`{
		"ent":[{"data":{"url":"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4"},"tp":"LN"}],
		"fmt":[{"len":22}],
		"txt":"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4"
	}`,
	`{
...
func TestPlainText(t *testing.T) {
	expect := []string{
		...
		"[FILE 'hello.jpg']",
		"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4](https://www.youtube.com/watch?v=dQw4w9WgXcQ)",
		"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4",
		"Url [one](https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4), [two](https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4)",
		"[IMAGE 'roses.jpg']",
...
func TestPreview(t *testing.T) {
	expect := []string{
		...
		`{"txt":"https://api.tin","fmt":[{"len":15}],"ent":[{"tp":"LN","data":{"url":"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4"}}]}`,
		`{"txt":"Url one, two","fmt":[{"at":4,"len":3},{"at":9,"len":3}],"ent":[{"tp":"LN","data":{"url":"https://youtu.be/iToH6GuN2S4?list=RDiToH6GuN2S4"}}]}`,
